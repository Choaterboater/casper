...
Casper distributes an unsigned **v0.2.5 preview**, not a stable release. Installers
default to `https://github.com/Choaterboater/casper/releases/download/v0.2.5` because
...
- Published v0.1.0 appends login selection messages instead of moving the highlight,
  and lacks every change listed above. Those corrections ship in v0.2.5.
